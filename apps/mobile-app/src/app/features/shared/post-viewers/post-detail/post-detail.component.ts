...
export class PostDetailComponent implements OnInit, OnDestroy {
  ...
  onChangeManagementLevelClick(mgmtLev: PostManagementLevel) {
    if (mgmtLev === this._post.mgmt_lev) {
      return;
    }
  ...
  onEditClick() {
    const createIncidentModalRef =
    this.modalService.open(PostEditorPageComponent, {ariaLabelledBy: 'modal-basic-title', windowClass : "customModalWindowClass" });
